...
function App() {                //Все передается одним элементом на отрисовку в компонент Card, в элементе название, описание и имя файла. Позже можно будет спокойно переделать под докер
    const [cards, setCards] = useState([
        ...
        {title: "Бойцовский клуб", body: "Сотрудник страховой компании страдает хронической бессонницей " +
                ...
                "невероятной популярностью.", img_id: "fight_club.jpg"},
        ...
        {title: "Пила 5", body: "Один из последователей маньяка-убийцы Пилы, Марк Хоффман, следуя заветам своего " +
                ...
                "по которым он присоединился к Пиле.", img_id: "saw.jpeg"},
        ...
        {title: "Дюна", body: "Наследник знаменитого дома Атрейдесов Пол отправляется вместе с семьей на " +
                ...
                "своему страху, достоин стать избранным.", img_id: "dune.jpg"},
    ])
  ...
  return (  //отрисовка заголовка сайта и чтение элемента, которая инфа для карточки фильма (компонент Card)
    <div className="App">
        ...
        {cards.map(card =>
            <Card card={card} key={card.img_id}/>
        )}
    </div>
  );
}
